...
<html>
<head>
	<title>Registro de centrales</title>
				...
				{{csrf_field()}}
					<div id="dynamic_container">
                        <div class="input-group">
                            Nombre descriptivo:&nbsp;
                            <input type="text" name="transmissionKW" placeholder="nombre" class="form-control" value={{$cen->transmissionKW}} />
						</div>
                        <br>						
					</div>
                    <br>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <button type="submit" name="B1" class="btn btn-primary" value={{$cen->geographicLocation}}>Editar</button>  
				</form>
			</div>
		</div>
	</div>
