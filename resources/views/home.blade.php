    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          <a class="dropdown-item" href="/registro">Registro de OPE/SUP</a>
         </div>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          <h6 class="dropdown-header">Listar empleados:</h6>
          <a class="dropdown-item" href="/listadoS">Lista de supervisores</a>
          <a class="dropdown-item" href="/listadoO">Lista de operadores</a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="/mapa">
          ...
          <span>Visualizar mapa de interconexion</span></a>
      </li>
